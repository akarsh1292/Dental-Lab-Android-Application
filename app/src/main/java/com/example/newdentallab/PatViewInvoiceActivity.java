...
public class PatViewInvoiceActivity extends AppCompatActivity {
    DatabaseHelper g;
    Button backbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pat_view_invoice);
        g=new DatabaseHelper(this);
        ListItem = new ArrayList<>();
        client_list=(ListView)findViewById(R.id.invoicepat_list);
        view_patinvoice();
        client_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String patid = extractPatIDFromItemData(itemData);


                // Perform action with Name and Phone values
                // For example, display in a Toast
                Intent intent = new Intent(PatViewInvoiceActivity.this,PatientInvoiceActivity.class);
        ...
        backbutton=(Button)findViewById(R.id.BackButtoninp);
        backbutton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PatViewInvoiceActivity.this,InvoicePatientActivity.class));
            }
        });
    }

    private String extractPatIDFromItemData(String itemData) {
        String[] lines = itemData.split("\n");
        String id = "";


        for (String line : lines) {
            if (line.startsWith("Patient A/C ID::")) {

                id = line.substring(16);
                break;
            }
        }
