...
public class ViewPatientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        client_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ViewPatientActivity.this, InvoicePatientActivity.class);
        ...
        backbutton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                startActivity(new Intent(ViewPatientActivity.this,PatientActivity.class));
            }
        });
    ...
    private void view_patient() {
        Cursor cursor = g.view_patient();
        if(cursor.getCount()==0){
            Toast.makeText(ViewPatientActivity.this,"NO DATA FOUND",Toast.LENGTH_SHORT).show();
        }else{
