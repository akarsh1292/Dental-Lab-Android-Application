...
public class UnpaidBalanceActivity extends AppCompatActivity {
    dbbal g;
    Button backbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbutton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                startActivity(new Intent(UnpaidBalanceActivity.this,BalanceActivity.class));
            }
        });
    ...
    private void view_balance() {
        Cursor cursor = g.view_unpaid();
        if(cursor.getCount()==0){
            Toast.makeText(UnpaidBalanceActivity.this,"NO DATA FOUND",Toast.LENGTH_SHORT).show();
        }else{
